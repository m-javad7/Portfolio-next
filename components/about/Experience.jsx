    ...
    return (
      <div className="flex flex-wrap ">
        {info.map(({ experience, projects, client, learn }) => (
          <>
            <div className="w-full md:w-[40%] h-52 border border-gray-700 p-8 mr-4 mt-4 flex flex-col hover:-translate-y-1 hover:border-green-700 hover:transition hover:delay-150 hover:duration-300 hover:ease-in-out">
